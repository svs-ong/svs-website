...
const VISION_TEXT : string[] = [`Viziunea Noastră Visăm la o lume în care învățăm împreună, punând un accent deosebit pe educație. 
      Viziunea noastră extinde educația dincolo de școli și universități, cultivând curiozitatea, gândirea 
      critică și promovând învățarea continuă pe tot parcursul vieții.`,`Ne propunem să organizăm evenimente în care elevii și studenții pot beneficia de experiența profesională a voluntarilor noștri din diverse 
      ...
      tinerilor.` , `Suntem conștienți că exemplul pe care îl dăm în calitate de membri și voluntari ai SVS este 
      esențial pentru a influența și inspira pe cei din jurul nostru. Ne străduim să fim modele autentice, 
      trăind valorile pe care le promovăm și implicându-ne activ în comunitate.` , `Ne angajăm să fim un factor de schimbare pozitivă în educație. Alătură-te nouă în această călătorie și să fim împreună forța 
